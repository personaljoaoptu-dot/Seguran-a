...
def test_remote_api():
    ...
    print("Testing remote API with correct credentials...")
    ...
    print("\nTesting remote API with incorrect credentials...")
    ...
    print("\nAll remote web API authentication checks passed successfully!")
