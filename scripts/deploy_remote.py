...
def deploy():
    ...
    try:
        ...
        n8n_cmds = [
            ...
            "docker exec -u node n8n_app n8n import:workflow --activeState=fromJson --input=/tmp/aegiseye_auth_workflow.json",
            ...
            "docker exec -u node n8n_app n8n import:workflow --activeState=fromJson --input=/tmp/n8n_registration_workflow.json",
            ...
            "docker exec -u node n8n_app n8n import:workflow --activeState=fromJson --input=/tmp/n8n_activation_workflow.json",
            ...
            "docker exec -u node n8n_app n8n import:workflow --activeState=fromJson --input=/tmp/n8n_camera_config_workflow.json",
            ...
            "docker exec -u node n8n_app n8n import:workflow --activeState=fromJson --input=/tmp/n8n_alerts_workflow.json",
